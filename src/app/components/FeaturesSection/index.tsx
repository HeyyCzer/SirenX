...
const features = [
	{
		...
		content: (
			<>
				We designed <span className="font-semibold text-white">SirenX</span> to
				be as simple as possible, so you can use it without any hassle. You
				don&apos;t need to be an expert to use it: just open the editor, import
				your{" "}
				<kbd>
	...
	},
	{
		...
		content: (
			<>
				We know how time-consuming it is to manually create/edit vehicle light
				patterns. <span className="font-semibold text-white">SirenX</span> is
				here to save your time. You can edit your{" "}
				<kbd>
					<kbd>carcols.meta</kbd>
				</kbd>{" "}
	...
	},
	{
		...
		content: (
			<>
				We believe that everyone should have access to the best tools, so we
				made <span className="font-semibold text-white">SirenX</span> absolutely
				free. You can use it as much as you want. If you like it, consider
				supporting us!
			</>
		),
	},
...
function FeatureCard({ emoji, title, content, index }: FeatureCardProps) {
	return (
		...
		>
			...
			<div className="pointer-events-none absolute -inset-px rounded-2xl bg-gradient-to-b from-emerald-400/0 to-emerald-400/0 opacity-0 transition-opacity duration-300 group-hover:from-emerald-400/5 group-hover:to-transparent group-hover:opacity-100" />
