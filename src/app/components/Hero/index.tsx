      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-16 lg:flex-row lg:gap-24">
        ...
        >
          ...
          >
            <Link
              href="#features"
              className="group flex items-center gap-2 rounded-lg bg-emerald-500 px-6 py-3 font-semibold text-sm text-white uppercase tracking-wide transition-all duration-300 hover:bg-emerald-400 hover:shadow-lg hover:shadow-emerald-500/25"
            >
              <FontAwesomeIcon icon={faMagicWandSparkles} className="transition-transform group-hover:rotate-12" />
              Features
            </Link>
            <Link
              href="/editor"
            ...
            >
              <FontAwesomeIcon icon={faEdit} className="transition-transform group-hover:scale-110" />
              Open Editor
            </Link>
          </m.div>
        </m.div>
