...
export default function AboutSection() {
	return (
		<section
			id="about"
			className="relative mx-auto max-w-4xl px-6 py-24 lg:px-12"
		>
			<m.div
			...
			>
				...
				>
					<span className="font-semibold text-white">SirenX</span> is a
					web-based{" "}
					...
					servers. We offer a simple and intuitive interface, so you can create
					your patterns in a few clicks.
				</m.p>
			</m.div>
		</section>
	);
