...
export default function EditorHeader() {
	...
	useEffect(() => {
		const fetchData = async () => {
			const response = await fetch("https://api.github.com/repos/heyyczer/sirenx");
  ...
  return (
    <div className="flex items-center gap-x-4">
      ...
      >
        <FontAwesomeIcon icon={faHome} className="text-white/60 transition-colors group-hover:text-emerald-400" />
